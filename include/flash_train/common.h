 ...
 * operation.
 */
FTRAIN_API FTrainStatus ftrainPlanCreate(FTrainPlan* plan, FTrainArgs args);
 ...
 * 1 when several implementations apply to the Plan's parameters; the
 * Primitives are ordered best-first.
 *
